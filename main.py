...
#CORSMiddleware se utiliza para permitir solicitudes desde diferentes orígenes (dominios) a la API, lo cual es esencial para el desarrollo frontend y pruebas. En este caso, se permiten solicitudes desde "http://localhost:5500" y cualquier otro origen ("*") para facilitar las pruebas.
origins = [
