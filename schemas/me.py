...
# Este schema se utiliza para la respuesta del endpoint /me, 
# donde se devuelve la información del usuario autenticado, 
# incluyendo su perfil de alumno o profesor si corresponde.
